...
emotions = ["anger", "contempt", "disgust", "fear", "happiness", "neutral", "sadness", "surprise"] #Emotion list Fear/Afarid?
...
def get_files(emotion): 
	files = glob.glob("EUStimulusEkmanVideos\\%s\\*" %emotion)
